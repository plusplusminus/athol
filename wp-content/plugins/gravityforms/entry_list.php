	...
	public static function leads_page( $form_id ) {
		...
		<ul class="subsubsub">
			...
			foreach ( $filter_links as $filter_link_index => $filter_link ) {
				...
				$filter_arg = $filter_link['id'] == 'all' ? '' : '&filter=' . $filter_link['id'];
				if ( $filter == '' ){
					$selected = $filter_link['id'] == '' ? 'current' : '';
				} else {
				...
				<li>
					<a class="<?php echo $selected ?>"
					   href="?page=gf_entries&view=entries&id=<?php echo absint( $form_id ) . $filter_arg ?>"><?php echo $filter_link['label']; ?>
						<span class="count">(<span
								id="<?php echo $filter_link['id']; ?>_count"><?php echo absint( rgar( $filter_link, 'count' ) ); ?></span>)</span></a><?php echo $separator ?>
				</li>
				<?php
			}
			?>
